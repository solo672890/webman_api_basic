...
class MonologExtendHandler extends StreamHandler {
     ...
     * @throws Exception
     */
    public function __construct($channelDirName = null, $maxFileSize = 10485760, $level = Logger::DEBUG, bool $bubble = true, int $filePermission = 0, bool $useLocking = false) {
...
//            $target = $logBasePath.  time() . '_' .  $filename;
            $target = $logBasePath . date('d').'_'.date('His') . '.log' ;
